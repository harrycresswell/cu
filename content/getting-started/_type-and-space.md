...
Use Utopia’s [Fluid Type Scale Calculator](https://utopia.fyi/type/calculator/) to modify typography. Once you are happy with your scale, copy the CSS generated by Utopia and use it to replace the existing type scale found inside `scss/abstracts/_type.scss`.
...
found inside `scss/abstracts/_space.scss`.
